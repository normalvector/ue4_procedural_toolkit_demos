...
USelectionSet * UStaticSetBPLibrary::Ease(USelectionSet *Value, EEasingFunc::Type easeFunction /*= EEasingFunc::Linear*/, int32 steps /*= 2*/, float blendExp /*= 2.0f*/)
{
	// Need a SelectionSet
	if (!Value) {
		return nullptr;
...
USelectionSet * UStaticSetBPLibrary::Subtract_SelectionSets(USelectionSet *A, USelectionSet *B)
{
	// Need both provided
	if (!A || !B) {
		return nullptr;
...
//}
//
//USelectionSet * UStaticSetBPLibrary::Min_SelectionSets(USelectionSet *A, USelectionSet *B)
//{
//	// Need both provided
//	if (!A || !B) {
//		return nullptr;
...
//}
//
//USelectionSet * UStaticSetBPLibrary::Max_SelectionSetAgainstFloat(USelectionSet *Value, float Float)
//{
//	// Need a SelectionSet
//	if (!Value) {
//		return nullptr;
...
//}
//
//USelectionSet * UStaticSetBPLibrary::Min_SelectionSetAgainstFloat(USelectionSet *Value, float Float)
//{
//	// Need a SelectionSet
//	if (!Value) {
//		return nullptr;
...
//}
//
//USelectionSet * UStaticSetBPLibrary::Lerp_SelectionSets(USelectionSet *A, USelectionSet *B, float Alpha/*=0*/)
//{
//	// Need both provided
//	if (!A || !B) {
//		return nullptr;
...
//}
//
//USelectionSet * UStaticSetBPLibrary::Lerp_SelectionSetWithFloat(USelectionSet *Value, float Float, float Alpha /*= 0*/)
//{
//	// Need a SelectionSet
//	if (!Value) {
//		return nullptr;
